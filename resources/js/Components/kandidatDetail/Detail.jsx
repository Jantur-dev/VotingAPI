      ...
      <div className="py-[10rem] xxs:mx-[2rem] md:mx-[13rem]">
        {vision.map((person, index) => (
          <div key={index} className="flex xxs:flex-col md:flex-row gap-6 mb-9 ">
            <button className="xxs:hidden md:flex relative bg-primary flex flex-end w-16 h-14 p-5 justify-center items-center gap-6 flex-shrink-0 rounded-lg mt-[1rem] hover:bg-secondary">
              <a href="">
