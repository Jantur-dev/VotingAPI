...
const Stats = () => (
  <section
    className={`${styles.flexCenter} xxs:w-[350px] xs:w-[450px] md:w-[950px] lg:w-[1350px] flex absolute xxs:right-1 xxs:mt-[4rem] md:right-1 left-1 md:mt-0 none  xxs:bg-[#FFFFFF] md:bg-white border-2 shadow-sit drop-shadow-xl rounded-xxl px-[5rem] mx-auto`}
  >
