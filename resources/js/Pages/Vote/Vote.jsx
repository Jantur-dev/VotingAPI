          ...
          <div className={`${styles.flexCenter} flex-wrap w-full mt-none md:mx-[1rem]`}>
            {clients.map((client) => (
              <div className="relative xxs:mx-auto md:mx-none h-[24.5rem] my-5">
                <div className={`relative flex-1 flex-col justify-around ${styles.flexCenter} xxs:min-w-[292px] min-w-[120px] mx-[.5rem] my-1 px-6 py-[1.5rem] rounded-lg border-b-4 shadow-pit border-blue-900 bg-[#FFFFFF]`} key={client.id}>
                      ...
                      <label htmlFor={`radio_${client.id}`} className="absolute bottom-0 left-1/2 transform -translate-x-1/2 -mb-12 cursor-pointer">
                        <span
                          ...
                          style={{
                            ...
                            zIndex: 2, // Tambahkan zIndex agar tetap berada di atas card
                          }}
                        />
                      </label>
                    </form>
